...
{
    /// <summary>
    /// <see cref="HyperCoreServiceHost"/> implementation that supports cancellation.
    /// </summary>
    public sealed class CancellableServiceHost : HyperCoreServiceHost
    {
        private readonly CancellationTokenSource _tokenSource = new();
        private readonly List<CancellationTokenRegistration> _cancellationCallbackRegistrations = new();
        ...
        public CancellableServiceHost(IHyperNodeService singletonInstance, params Uri[] baseAddresses)
        ...
        /// <summary>
        /// Communicates a request for cancellation. This method can only be called when the <see cref="CancellableServiceHost"/> is in the <see cref="HyperCoreServiceHost.CommunicationState.Opened"/>, <see cref="HyperCoreServiceHost.CommunicationState.Faulted"/>, or <see cref="HyperCoreServiceHost.CommunicationState.Closing"/> state.
        /// </summary>
        public void Cancel()
        {
